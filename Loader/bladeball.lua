...
local Window = Fluent:CreateWindow({
    Title = "Dooxbox Hub",
    SubTitle = "discord.gg/qYraTpHJAt",
    TabWidth = 160,
...
Tabs.Misc:AddParagraph({Title = "Discord", Content = "discord.gg/qYraTpHJAt"})
...
InterfaceManager:SetFolder("DooxboxHub")
SaveManager:SetFolder("DooxboxHub/config")
InterfaceManager:BuildInterfaceSection(Tabs.Settings)
SaveManager:BuildConfigSection(Tabs.Settings)

Window:SelectTab(1)

Fluent:Notify({Title = "Dooxbox Hub", Content = "Loaded - discord.gg/qYraTpHJAt", Duration = 8})
